...
export default function defineUserModel(sequelize: Sequelize) {
  class UserModel extends Model<IUserAttributes> {
    ...
    public static associate(models: any): void {
      UserModel.hasMany(models.GroupModel, {
        foreignKey: "owner_id",
        as: "groups",
      });
      UserModel.hasMany(models.FileModel, {
        foreignKey: "owner_id",
        as: "files",
      });
      UserModel.hasMany(models.BookingModel, {
        foreignKey: "user_id",
        as: "bookings",
      });
      UserModel.hasMany(models.UserGroupModel, {
        foreignKey: "user_id",
        as: "user_groups",
      });
      UserModel.hasMany(models.ArchiveModel, {
        foreignKey: "user_id",
        as: "archives",
      });
    }
